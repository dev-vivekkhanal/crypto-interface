...
const HomePage = () => {
  ...
  return (
    <motion.div
      ...
      className="py-40 pb-24 sm:py-28 sm:pb-24"
    >
              ...
              return (
                <React.Fragment key={data?.id}>
                  ...
                  <motion.div
                    ...
                    className="hidden lg:grid grid-cols-8 gap-5 items-center py-5 border-b hover:bg-gray-50 "
                  >
                    {/* Name */}
                  ...
                  <Link
                    to={"crypto/" + data?.id}
                    className="lg:hidden bg-gray-50 p-5  border border-gray-100 mb-5 rounded-lg block"
                  >
                    <div className="flex justify-between">
                      ...
                      <div className="flex gap-5 items-center ">
                        ...
                        {/* name */}
                        <div className=" ">
                          <h1 className="font-semibold text-lg hover:underline-offset-4 hover:underline transition-all cursor-pointer">
                            {data?.name}
                          </h1>
                          <h2 className="text-sm text-gray-500">
                            {data?.code_name}
